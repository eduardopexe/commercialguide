...
*/
			...
			output += '                        <li id="99999" class="list-group-item" onclick="showdet(99999)">';
			output += '                            <div class="row">';
			output += '                            <p align="center">';
			output += '                               <img src="assets/images/t1.gif" alt="Destaque">';
			output += '                            </p><br><br>';
			output += '                            </div>'
			output += '                        </li>';
            ...
            var count = 1;
			  $.each(data2, function(key, val){
				if ((val.tipo_estabelecimento.search(regex) != -1) || (val.nome_fantasia.search(regex) != -1)) {
                  ...
                  output += '                                            <img src="assets/images/' + val.logo_empresa + '" alt="Guia GO" class="img-responsive img-circle rounded-circle" />';
                  output += '                                        </div>';
