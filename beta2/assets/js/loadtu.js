...
const urlto = 'https://guia.liinkoo.com/api/teluteis.php?iddet=' + detid
...
*/	    output += '<p align="center"><img src="assets/images/' + val.logo_empresa + '" width="64" heigth="64" alt="Logo" title="Logo"><font size="3">&nbsp;&nbsp;&nbsp;<b>' + val.nome_fantasia + '</b></font></p><ul class="container flex">';
	    ...
	    output += '<li class="item flex-item"><figure><a href="https://wa.me/55' + val.whatsapp + '" class="hide-search text-secondary" data-command="toggle-search" data-toggle="tooltip" data-placement="top" title="Toggle Search">';
        ...
        output += '<li class="item flex-item"><figure><a href="https://fb.com/' + val.facebook + '" class="hide-search text-secondary" data-command="toggle-search" data-toggle="tooltip" data-placement="top" title="Toggle Search">';
        ...
        output += '<li class="item flex-item"><figure><a href="https://instagram.com/' + val.instagram + '" class="hide-search text-secondary" data-command="toggle-search" data-toggle="tooltip" data-placement="top" title="Toggle Search">';
        ...
        output += '<li class="item flex-item"><figure><a href="' + val.website + '" class="hide-search text-secondary" data-command="toggle-search" data-toggle="tooltip" data-placement="top" title="Toggle Search">';
